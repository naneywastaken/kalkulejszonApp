package com.example.kalkulujapp
...
import com.example.kalkulujapp.ui.theme.KalkulujAppTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // View Binding can replace findViewById for better performance and null safety
        ...
        doublezero.setOnClickListener {
            if(expression.text.toString().startsWith("0")){
                str = expression.text.toString().replace("0","") + "000"
                expressionText(str)
                resultText()

            }else{
                str = expression.text.toString() + "000"
                expressionText(str)
                resultText()
